...
const Navbar = () => {
  ...
  return (
    <header className="relative px-8 py-10 lg:px-32  flex items-center justify-between font-medium dark:text-light">
      <button
      ...
      {isOpen && (
        <motion.div
          ...
          className="min-w-[70vw] flex flex-col items-center justify-between border fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 lg:hidden bg-dark/90 dark:bg-light/75 rounded-lg backdrop-blur-md py-24 gap-5 z-30"
        >
      ...
      <div className="absolute left-[50%] translate-x-[-50%] lg:top-10">
        <Logo />
      </div>
    </header>
  );
