...
const Navbar = () => {
  ...
  return (
    <header className="relative px-8 py-8 lg:px-32  flex items-center justify-between font-medium dark:text-light">
      <button
      ...
      <div className="absolute left-[50%] translate-x-[-50%] md:top-6">
        <Logo />
      </div>
    </header>
  );
